...
while True :
    if (((vehicle.location.local_frame.north-stm_pist[0])**2+(vehicle.location.local_frame.east-stm_pist[1])**2)**0.5) < 1.5:
        break
...
arm_and_takeoff(6)
position(odtu_pist[0],odtu_pist[1],6,0)

while True:
    if ((((vehicle.location.local_frame.north+stm_pist[0])-odtu_pist[0])**2+((vehicle.location.local_frame.east+stm_pist[1])-odtu_pist[1])**2)**0.5) < 1.5:
        break
...
arm_and_takeoff(6)
position(ort_pist[0],ort_pist[1],6,0)

while True :
    if ((((vehicle.location.local_frame.north+odtu_pist[0])-ort_pist[0])**2+((vehicle.location.local_frame.east+odtu_pist[1])-ort_pist[1])**2)**0.5) < 1.5:
        break
...
arm_and_takeoff(6)
position(landing_pist[0],landing_pist[1],6,0)

while True :
        if ((((vehicle.location.local_frame.north+ort_pist[0])-landing_pist[0])**2+((vehicle.location.local_frame.east+ort_pist[1])-landing_pist[1])**2)**0.5) < 1.5:
            break
